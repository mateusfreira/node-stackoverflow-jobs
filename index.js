...
var StackoverflowJobs = function () {
  ...
  this.search = function (filters) {
    ...
    return rp('http://careers.stackoverflow.com/jobs/feed?' + toQueryString(filters)).then(function (feedsString) {
      return parseString(feedsString).then(function (feedsObj) {
